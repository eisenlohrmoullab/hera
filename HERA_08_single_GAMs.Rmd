...
gam_output_base <- "~/Library/CloudStorage/Box-Box/00 - CLEAR Lab (Locked Folders)/02 - Data Management, Analysis, and Papers/Studies_Projects/HERA/03_analytic_projects/HERA-Primary ms/03_code_dataedits_output/06_Single_GAMs/"
...
outcome_categories <- tribble(
  ~category, ~variable,
  "Number of Drinks", "DRSP Total", "Distress (DRSP)", "Social/Affect Lability (DRSP)", "Breast Sx (DRSP)", "Eating Sx", "Low Arousal Sx (DRSP)", "Depression", "Hopelessness", "Worthlessness", "Anxiety", "Mood Swings", "Rejection Sensitivity", "Anger/Irritability", "Interpersonal Conflicts", "Loss of Interest", "Feeling Overwhelmed", "Feeling Out of Control", "Difficulty Concentrating", "Fatigue/Lethargy", "Hypersomnia", "Insomnia", "Overeating", "Specific Food Cravings", "Breast Tenderness", "Breast Swelling", "Headache", "Joint/Muscle Pain"
) %>%
